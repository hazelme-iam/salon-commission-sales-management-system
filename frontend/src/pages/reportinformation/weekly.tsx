...
const WeeklyReportList: React.FC = () => {
    ...
    const exportCSV = () => {
        const csvContent = [
            ["ID", "Total Sales", "Commission", "Total Revenue", "Transactions", "Date"],
    ...
    const exportTXT = () => {
        const content = sampleData.map(row =>
            `ID: ${row.id}, Total Sales: ${row.total_sales}, Commission: ${row.commission}, Total Revenue: ${row.total_revenue}, Transactions: ${row.transactions}, Date: ${row.date}`
        ).join("\n");
        ...
        <>
            ...
            <div className="main-content app-content">
                ...
                <div className="flex gap-4 mb-4">
                    ...
                    <Button variant="outlined" color="inherit" onClick={exportTXT}>
                        Export TXT
                    </Button>
                </div>
