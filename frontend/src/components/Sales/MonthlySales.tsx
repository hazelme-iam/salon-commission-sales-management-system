...
const MonthlySales: React.FC = () => {
  ...
  return (
    <div className="p-4 bg-white rounded-lg shadow-md">
      <h2 className="text-lg font-semibold mb-3 text-center">Monthly Sales Summary</h2>
      ...
      <div className="p-4 bg-pink-300 rounded-lg shadow-sm flex items-center gap-3 mb-3">
        ...
        <div>
          ...
          <p className="text-black-600 text-sm"> Monthly Total Sales</p>
        </div>
      </div>
      ...
      <div className="p-4 bg-pink-300 rounded-lg shadow-sm flex items-center gap-3 mb-3">
        ...
        <div>
          ...
          <p className="text-black-600 text-sm">Monthly Total Revenue</p>
        </div>
      </div>
      ...
      <div className="p-4 bg-pink-300 rounded-lg shadow-sm flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-black-600 text-sm">Monthly Total Commission</p>
        </div>
      </div>
    </div>
  );
